...
var useInsertionEffect = index_js_['useInsertion' + 'Effect'] ? index_js_['useInsertion' + 'Effect'] : false;
...
var emotion_use_insertion_effect_with_fallbacks_esm_useInsertionEffectWithLayoutFallback = useInsertionEffect || index_js_.useLayoutEffect;
...
var EmotionCacheContext = /* #__PURE__ */index_js_.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
var emotion_element_6bdfffb2_esm_ThemeContext = /* #__PURE__ */index_js_.createContext({});

if (false) {}

var useTheme = function useTheme() {
  return React.useContext(emotion_element_6bdfffb2_esm_ThemeContext);
};
...
var ThemeProvider = function ThemeProvider(props) {
  var theme = React.useContext(emotion_element_6bdfffb2_esm_ThemeContext);

  if (props.theme !== theme) {
    theme = createCacheWithTheme(theme)(props.theme);
  }

  return /*#__PURE__*/React.createElement(emotion_element_6bdfffb2_esm_ThemeContext.Provider, {
    value: theme
  }, props.children);
};
...
var Emotion = /* #__PURE__ */emotion_element_6bdfffb2_esm_withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = emotion_serialize_esm_serializeStyles(registeredStyles, undefined, index_js_.useContext(emotion_element_6bdfffb2_esm_ThemeContext));
  ...
  }), /*#__PURE__*/index_js_.createElement(WrappedComponent, newProps));
});
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !emotion_element_6bdfffb2_esm_hasOwnProperty.call(props, 'css')) {
    // $FlowFixMe
    return index_js_.createElement.apply(undefined, args);
  }
  ...
  return index_js_.createElement.apply(null, createElementArgArray);
};
...
var React = _interopRequireWildcard(__webpack_require__(1785));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(1785);
...
var _react = _interopRequireDefault(__webpack_require__(1785));
...
exports.components={"component---src-pages-404-tsx":()=>__webpack_require__.e(/* import() | component---src-pages-404-tsx */ 218).then(__webpack_require__.bind(__webpack_require__, 2513)),"component---src-pages-index-tsx":()=>Promise.all(/* import() | component---src-pages-index-tsx */[__webpack_require__.e(248), __webpack_require__.e(691)]).then(__webpack_require__.bind(__webpack_require__, 9903))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(4988),options:{"plugins":[],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(5822),options:{"plugins":[],"icon":"src/images/icon.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"53aa06cf17e4239d0dba6ffd09854e02"}},{name:'gatsby-plugin-google-fonts',plugin:__webpack_require__(7325),options:{"plugins":[],"fonts":["Raleway","Red Hat Display"],"display":"swap"}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1785);
...
function HTML(props){return (0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("html",props.htmlAttributes,(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("head",null,(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("meta",{charSet:"utf-8"}),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("meta",{httpEquiv:"x-ua-compatible",content:"ie=edge"}),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("meta",{name:"viewport",content:"width=device-width, initial-scale=1, shrink-to-fit=no"}),props.headComponents),(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("body",props.bodyAttributes,props.preBodyComponents,(0,_emotion_react__WEBPACK_IMPORTED_MODULE_1__/* .jsx */ .tZ)("div",{key:`body`,id:"___gatsby",dangerouslySetInnerHTML:{__html:props.body}}),props.postBodyComponents));}HTML.propTypes={htmlAttributes:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),headComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array),bodyAttributes:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().object),preBodyComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array),body:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().string),postBodyComponents:(prop_types__WEBPACK_IMPORTED_MODULE_2___default().array)};
...
const propErrors=validateSliceProps(props);if(Object.keys(propErrors).length){throw new SlicePropsError(slicesContext.renderEnvironment===`browser`,internalProps.sliceName,propErrors,props.__renderedByLocation);}if(slicesContext.renderEnvironment===`server`){return (0,emotion_react_esm/* jsx */.tZ)(ServerSlice,internalProps);}else if(slicesContext.renderEnvironment===`browser`){// in the browser, we'll just render the component as is
return (0,emotion_react_esm/* jsx */.tZ)(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`engines`||slicesContext.renderEnvironment===`dev-ssr`){// if we're in SSR, we'll just render the component as is
return (0,emotion_react_esm/* jsx */.tZ)(InlineSlice,internalProps);}else if(slicesContext.renderEnvironment===`slices`){// we are not yet supporting nested slices
...
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3240);
const React=__webpack_require__(1785);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(1498);const{parse}=__webpack_require__(698);const styleToOjbect=__webpack_require__(7848);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(1785));var _gatsby=__webpack_require__(7076);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(1785));var _gatsby=__webpack_require__(7076);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(1785),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/alvarobarros/Projects/alvbarros.github.io/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/alvarobarros/Projects/alvbarros.github.io/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/alvarobarros/Projects/alvbarros.github.io/node_modules/react/index.js");
...
/* harmony import */ var react_server_dom_webpack_writer_node_server__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2442);
const React=__webpack_require__(1785);const path=__webpack_require__(1423);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1498);const{ServerLocation,Router,isRedirect}=__webpack_require__(7896);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7076);const fs=__webpack_require__(7314);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const{headHandlerForSSR}=__webpack_require__(923);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(8995);const{ServerSliceRenderer}=__webpack_require__(7529);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
...
global.unsafeBuiltinUsage=[];try{let bodyHtml=``;let headComponents=[(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)("meta",{name:"generator",content:`Gatsby ${gatsbyVersion}`,key:`generator-${gatsbyVersion}`})];let htmlAttributes={};let bodyAttributes={};let preBodyComponents=[];let postBodyComponents=[];let bodyProps={};function loadPageDataSync(_pagePath){if(_pagePath===pagePath){// no need to use fs if we are asking for pageData of current page
...
const slicesDb=new Map();for(const sliceName of Object.values(slicesMap)){const slice=sliceData[sliceName];const{default:SliceComponent}=await getPageChunk(slice);const sliceObject={component:SliceComponent,sliceContext:slice.result.sliceContext,data:slice.result.data};slicesDb.set(sliceName,sliceObject);}body=(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(SlicesResultsContext.Provider,{value:slicesDb},body);}body=(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(SlicesContext.Provider,{value:slicesContext},(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(SlicesPropsContext.Provider,{value:sliceProps},(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(SlicesMapContext.Provider,{value:slicesMap},body)));}const bodyComponent=(0,_emotion_react__WEBPACK_IMPORTED_MODULE_0__/* .jsx */ .tZ)(StaticQueryContext.Provider,{value:staticQueryContext},body);// Let the site or plugin render the page component.
