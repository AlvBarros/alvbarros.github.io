...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.connection.onopen = function () { _this.onopen(); };
        this.connection.onerror = function () { _this.onerror(); };
        this.connection.onmessage = function (message) { _this.onmessage(message); };
    }
    ...
    AppComponent.prototype.enterChat = function () {
    };
    ...
    AppComponent.prototype.receiveMessage = function (autor, mensagem) {
